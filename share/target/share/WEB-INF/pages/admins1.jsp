                ...
                <div class="panel-group table-responsive" role="tablist">
                    ...
                    <div class="panel panel-primary leftMenu">
                        ...
                        <div id="collapseListGroup4" class="panel-collapse collapse in" role="tabpanel"
                            ...
                            <ul class="nav">
                                ...
                                <li>
                                    <a href="javascript:;" path='<c:url value="/attention/listscan.html"/> '>浏览历史（前10）</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="panel panel-primary leftMenu">
                        ...
                        <div id="collapseListGroup5" class="panel-collapse collapse in" role="tabpanel"
                            ...
                            <ul class="nav">
                                <li>
                                    <a href="javascript:;" path='<c:url value="/order/sharepools.html"/> '>共享池</a>
                                </li>
                                <li>
                                    <a href="javascript:;" path='<c:url value="/order/shareorders.html"/> '>订单</a>
                                </li>
                            </ul>
                        </div>
                    </div>
