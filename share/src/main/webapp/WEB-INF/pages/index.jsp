...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="${basePath}/index.html">校园共享平台</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="${basePath}/admin.html?type=sharepools" target="_blank">共享池(${poolCount})</a></li>
                <li><a href="javascript:;" id="exchange">物品申请区</a></li>
...
<script type="text/javascript">
    $(function () {
        var url ="${basePath}/list/article.html";
    ...
    $(function () {
        $('#exchange').click(function () {
            ...
            if(text.indexOf("申请")>=0){
                $.load.a('${basePath}/list/need.html');
                $(this).text("共享资源区");
            }else {
                $.load.a('${basePath}/list/article.html');
                $(this).text("物品申请区");
            }
        });
    });
