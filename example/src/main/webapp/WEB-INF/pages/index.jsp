...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">校园共享</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav" id="mynav">
                ...
                <li class="active"><a href="javascript:;" path='<c:url value="/list/home.html"/> '>首页</a></li>
                <li><a href="javascript:;" path='<c:url value="/list/article.html"/> '>资源</a></li>
                <li><a href="javascript:;" path='<c:url value="/list/need.html"/> '>急需</a></li>
                <li><a href="javascript:;" path='<c:url value="/list/topic.html"/> '>讨论区</a></li>
            </ul>
...
<script type="text/javascript">
    $(function () {
        var url = $('#mynav li a:first').attr("path");
